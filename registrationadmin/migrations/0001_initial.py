# Generated by Django 3.2 on 2024-07-12 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organization.organization')),
                ('scheme_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='registrationadmin.payment', verbose_name='Scheme name')),
            ],
            options={
                'verbose_name': 'Scheme',
            },
