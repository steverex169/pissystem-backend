    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('Created', 'Created'), ('Ready', 'Ready'), ('Issued', 'Issued'), ('Open', 'Open'), ('Saved', 'Saved'), ('Submitted', 'Submitted'), ('Closed', 'Closed'), ('Report Available', 'Report Available')], default='Inactive', max_length=50)),
