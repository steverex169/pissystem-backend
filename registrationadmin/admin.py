...
class RoundAdmin(admin.ModelAdmin):
    list_display = ('id', 'organization_id', 'rounds', 'scheme', 'cycle_no', 'sample', 'participants', 'issue_date', 'closing_date', 'notes', 'status')
    search_fields = ('id', 'organization_id', 'rounds', 'scheme', 'cycle_no', 'sample', 'participants', 'issue_date', 'closing_date', 'notes', 'status')
