    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('landline', models.CharField(help_text='Please use the format: +922134552799', max_length=13, null=True)),
                ('fax', models.CharField(help_text='Please use the format: + (Country Code) (City Code without the leading zero) (fax number)', max_length=13, null=True)),
