    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='organizationdata.organization')),
                ('instruments', models.ManyToManyField(blank=True, to='databaseadmin.instrument')),
                ('methods', models.ManyToManyField(blank=True, to='databaseadmin.method')),
                ('qualitativetype', models.ManyToManyField(blank=True, to='databaseadmin.qualitativetype')),
                ('reagents', models.ManyToManyField(blank=True, to='databaseadmin.reagents')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='databaseadmin_activity_log_units', to='organizationdata.organization')),
