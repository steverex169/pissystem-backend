...
from organizationdata.views import NewsListView, NewsAddAPIView, PartnersList, Statements2View, AccountsListsView, RegisterOrganizationView, OrganizationListView, OrganizationListUpdateAPIView, OrganizationListDeleteAPIView
